...
-- Soru: Sirali tablodan 4. kayittan 7.kayida kadar olan kayitlari listeleyin
select * from musteri_urun order by urun_id  offset 3 limit 3
CREATE TABLE maas
(
id int, 
musteri_isim varchar(50),
...
INSERT INTO maas VALUES (20, 'Ali', 7500); 
INSERT INTO maas VALUES (10, 'Veli', 10000); 
...
select * from maas
--En yuksek maasi alan musteriyi listeyin
...
/*
Satir atlmak istedigimizde offset komutunu kullaniriz.
*/
